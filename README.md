...
## Project Structure
    ...
    ├── mind_gamified_careg_35192  # Django project configurations
...
1. Clone this repo and `cd mind_gamified_careg_35192`
...
2. Clone this repo and `cd mind_gamified_careg_35192`
